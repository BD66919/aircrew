...
public interface DoubleFlightService {
    ...
    String moreDoubleFlight(Model model);
    String filterDoubleFlight(Model model);
    Map<String, Object> updateDoubleFlight(HttpServletRequest request);
    Map<String, Object> updateMoreDoubleFlight(HttpServletRequest request);
    ...
    void downloadMoreDoubleFlight(HttpServletResponse response) throws IOException;
